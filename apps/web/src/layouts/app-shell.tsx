    ...
    <div className="min-h-screen bg-page-mesh px-3 py-3 text-ink-950 md:px-5 md:py-5">
      <div className="mx-auto grid min-h-[calc(100vh-24px)] max-w-[1680px] grid-cols-1 gap-4 lg:grid-cols-[320px_minmax(0,1fr)]">
        <motion.aside
          ...
          className={cn(
            "fixed inset-y-3 left-3 z-40 w-[300px] rounded-[32px] border border-white/10 p-5 shadow-[0_28px_65px_-36px_rgba(0,0,0,0.26)] transition duration-300 lg:static lg:inset-auto lg:block lg:w-auto",
        ...
        <motion.main
          ...
          className="relative overflow-hidden rounded-[36px] border border-white/10 p-3 shadow-[0_28px_70px_-34px_rgba(0,0,0,0.24)] md:p-5"
